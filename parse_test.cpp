...
print x + y, z + n
    ...
    //cerr << "TestSimpleProgram 1" << endl;
    tree->Execute(closure, context);
    //cerr << "TestSimpleProgram 2" << endl;
...
// print r, c, t1, t2
    //cerr << "TestClassicalPolymorphism. 1" << endl;
    runtime::DummyContext context;

    runtime::Closure closure;
    auto tree = ParseProgramFromString(program);
    //cerr << "TestClassicalPolymorphism. 2" << endl;
    tree->Execute(closure, context);
    /*
    try {
        tree->Execute(closure, context);
    ...
    */
    ...
    //cerr << "TestClassicalPolymorphism. 3" << endl;
    
    string ss = context.output.str();
    //cerr << "TestClassicalPolymorphism. 3_1 " << ss << endl;
    ASSERT_EQUAL(ss,
                 "Rect(10x20) Circle(52) Triangle(3, 4, 5) Wrong triangle\n"s);
    //cerr << "TestClassicalPolymorphism. 4" << endl;
}
